...
TEST_CASES = {
    ...
    9: [("read", "alice", "username.txt"), ("write", "alice", "emails.txt"), ("read", "alice", "password.txt"), ("write", "alice", "password.txt")], # Alice reads username.txt then writes to emails.txt, next she reads password.txt and finally writes to password.txt
